...
public class CreateAdServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getSession().getAttribute("failedCreate") == null) {
            request.getSession().setAttribute("failedCreate", false);
        }
...
//        request.getSession().setAttribute("message", "Oops! Something went wrong.");
        ...
        if (title.equals("")) {
            ...
            request.getSession().setAttribute("failedCreate", true);
